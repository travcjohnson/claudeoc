      ...
      <div className="mx-auto max-w-[89.5rem] px-6 lg:px-10">
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          {highlights.map((h) => (
            ...
            >
              <p className="font-sans text-2xl font-bold text-slate-dark">
                {h.stat}
              </p>
              <p className="mt-1 font-sans text-sm font-semibold text-slate-medium">
                {h.label}
              </p>
              <p className="mt-3 font-serif text-sm text-slate-light">
                {h.description}
              </p>
            </div>
          ))}
        </div>
        <p className="mt-12 text-center font-serif text-lg italic text-slate-light">
