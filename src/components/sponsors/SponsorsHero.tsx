  ...
  return (
    <section className="bg-ivory-light pt-32 pb-24 lg:pb-32">
      <div className="mx-auto max-w-[89.5rem] px-6 lg:px-10">
        ...
        <h1 className="mt-8 max-w-3xl font-sans text-4xl font-bold tracking-tight text-slate-dark md:text-5xl lg:text-6xl">
          Partner With Orange County&apos;s Fastest-Growing AI Community
        </h1>
        <p className="mt-6 max-w-2xl font-serif text-xl leading-relaxed text-slate-light">
