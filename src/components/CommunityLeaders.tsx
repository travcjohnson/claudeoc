      ...
      <div className="max-w-[89.5rem] mx-auto px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <ul className="space-y-5">
              {benefits.map((benefit) => (
                <li key={benefit} className="flex items-start gap-4">
                  ...
                  <span className="font-serif text-slate-dark leading-relaxed">
                    {benefit}
                  </span>
                </li>
              ))}
          ...
          <div className="bg-white rounded-xl border border-slate-dark/10 p-8">
            <h3 className="font-sans font-semibold text-2xl text-slate-dark mb-4">
              Partner With ClaudeOC
            </h3>
            <p className="font-serif text-slate-light leading-relaxed mb-4">
            ...
            <p className="font-serif text-sm text-cloud-medium leading-relaxed mb-8">
